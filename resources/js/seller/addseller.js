$(document).ready(function() {
    ...
    $('input[name="image"]').on('change', function(e) {
        ...
        reader.onload = function(image) {
            ...
            let imageContent = image.target.result;
    ...
    $('form[name="add_seller"]').on('submit', function(event) {
        ...
        let descri = CKEDITOR.instances['seller_descri'].getData(),
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == 'done') {
                        ...
                        location.replace(`${window.location.protocol}//${window.location.hostname}/admin/viewseller`);
                    }
                }
            });
