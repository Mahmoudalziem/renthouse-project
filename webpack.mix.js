...
mix.js("resources/js/app.js", "public/js")
    ...
    //// ForgetPassword Assets
    .js("resources/js/pages/forget.js", "public/js/pages")
    .sass("resources/sass/pages/forget.scss", "public/css/pages")
    /////reset
    .js("resources/js/pages/reset.js", "public/js/pages")
    .sass("resources/sass/pages/reset.scss", "public/css/pages")
    //// register Assets
    ...
    .sass("resources/sass/pages/services.scss", "public/css/pages")
    //// services Show Assets
    .js("resources/js/pages/show.js", "public/js/pages")
    .sass("resources/sass/pages/show.scss", "public/css/pages")
    //// Add House
    .js("resources/js/houses/addhouse.js", "public/js/houses")
    .sass("resources/sass/houses/addhouse.scss", "public/css/houses")
    ///// View Seller
    .js("resources/js/seller/viewseller.js", "public/js/seller")
    .sass("resources/sass/seller/viewseller.scss", "public/css/seller")
    ///// Add Seller
    .js("resources/js/seller/addseller.js", "public/js/seller")
    .sass("resources/sass/seller/addseller.scss", "public/css/seller")
    //// Renter Assets
    .js("resources/js/renter/renter.js", "public/js/renter")
    .sass("resources/sass/renter/renter.scss", "public/css/renter")
    //// Admin Assets
